...
const CheckoutNavbar = ({ activeStep }) => {
  return (
    <div
      ...
      className="hidden h-[157px] w-full max-w-full md:flex flex-col items-center bg-white mt-1"
    >
      <nav
        id="nav-checkout"
      ...
      >
        ...
        >
          <span
            ...
            className={`inline-flex items-center justify-center w-[30px] h-[30px] border-2 border-solid rounded-[12px] mr-[8px] ${
              activeStep === 1 || activeStep === 2
                ? "bg-[#ff6700] text-[#fff] border-[#ff6700]"
                : "border-[#d0d0d0]"
            }`}
          >
            1
          ...
          <span
            id="step1_text"
            className={
              activeStep === 1 || activeStep === 2 ? "text-[#ff6700]" : ""
            }
          >
            Keranjang
          </span>
        ...
        >
          ...
          <span
            id="step2_text"
            className={activeStep === 2 ? "text-[#ff6700]" : ""}
          >
            Tempatkan pesanan
          </span>
        </div>
        ...
        >
          ...
          <span
            id="step3_text"
            className={activeStep === 3 ? "text-[#ff6700]" : ""}
          >
            Ulasan
          </span>
        </div>
